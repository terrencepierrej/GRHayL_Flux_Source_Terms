 ...
 */
void calculate_all_source_terms(const rhss_paramstruct *restrict rhss_params, const prims_struct *restrict prims, const metric_quantities_struct *restrict metric_quantities, const metric_quantities_derivatives_struct *restrict metric_quantities_derivatives, conservative_sources_struct *restrict conservative_sources) {

{
const double u4U3 = prims->u4U3;
const double u4U0 = prims->u4U0;
const double P = prims->P;
const double BU1 = prims->BU1;
const double u4U1 = prims->u4U1;
const double u4U2 = prims->u4U2;
const double rhob = prims->rhob;
const double h = prims->h;
const double BU0 = prims->BU0;
const double sqrt4pi = rhss_params->sqrt4pi;
const double BU2 = prims->BU2;
...
const double hDD_dD121 = metric_quantities_derivatives->hDD_dD121;
  ...
  conservative_sources->StildeD0_rhs = tmp_102*tmp_98 + tmp_107*tmp_81 + tmp_110*tmp_82 + tmp_112*tmp_91 + tmp_115*(-alpha_dD0*tmp_113 + tmp_40*vetU_dD00 + tmp_41*vetU_dD10 + tmp_42*vetU_dD20 + tmp_83*vetU0 + tmp_92*vetU1 + tmp_98*vetU2) + tmp_5*tmp_69 + tmp_70*tmp_73 + tmp_74*tmp_77 + tmp_83*tmp_89 + tmp_92*tmp_97;
  conservative_sources->StildeD1_rhs = tmp_102*tmp_128 + tmp_107*tmp_122 + tmp_110*tmp_123 + tmp_112*tmp_126 + tmp_115*(-alpha_dD1*tmp_113 + tmp_124*vetU0 + tmp_127*vetU1 + tmp_128*vetU2 + tmp_40*vetU_dD01 + tmp_41*vetU_dD11 + tmp_42*vetU_dD21) + tmp_117*tmp_69 + tmp_118*tmp_73 + tmp_119*tmp_77 + tmp_124*tmp_89 + tmp_127*tmp_97;
  conservative_sources->StildeD2_rhs = tmp_102*tmp_141 + tmp_107*tmp_135 + tmp_110*tmp_136 + tmp_112*tmp_139 + tmp_115*(-alpha_dD2*tmp_113 + tmp_137*vetU0 + tmp_140*vetU1 + tmp_141*vetU2 + tmp_40*vetU_dD02 + tmp_41*vetU_dD12 + tmp_42*vetU_dD22) + tmp_130*tmp_69 + tmp_131*tmp_73 + tmp_132*tmp_77 + tmp_137*tmp_89 + tmp_140*tmp_97;
  conservative_rhs->tau_tilde_rhs = tmp_67*(alpha_dD0*(-tmp_142 - tmp_88) + alpha_dD1*(-tmp_114*vetU1 - tmp_96) + alpha_dD2*(-tmp_101 - tmp_114*vetU2) + tmp_149*(tmp_146*vetU1 + tmp_150) + tmp_149*(tmp_147*vetU0 + tmp_150) + tmp_151*(tmp_146*vetU2 + tmp_152) + tmp_151*(tmp_148*vetU0 + tmp_152) + tmp_153*(tmp_147*vetU2 + tmp_154) + tmp_153*(tmp_148*vetU1 + tmp_154) + (aDD00*tmp_1 + tmp_145*tmp_2)*(tmp_114*((vetU0)*(vetU0)) + tmp_146*vetU0 + tmp_66) + (aDD11*tmp_1 + tmp_145*tmp_9)*(tmp_114*((vetU1)*(vetU1)) + tmp_147*vetU1 + tmp_72) + (aDD22*tmp_1 + tmp_13*tmp_145)*(tmp_114*((vetU2)*(vetU2)) + tmp_148*vetU2 + tmp_76));
}
}
