...
static inline void compute_P_cold__gamma_cold(CCTK_REAL rho_b,eos_struct *restrict eos,   CCTK_REAL P_cold,CCTK_REAL gamma_cold);
static inline void monotonize(CCTK_REAL U,CCTK_REAL Ur,CCTK_REAL Ul);

void reconstruct_set_of_prims_PPM(const paramstruct *restrict params, const cGH *cctkGH,const int *cctk_lsh,const int flux_dirn,const int num_prims_to_reconstruct,const int *which_prims_to_reconstruct,eos_struct *restrict eos,
...
static void ftilde_gf_compute(const paramstruct *restrict params, const cGH *cctkGH,const int *cctk_lsh,const int flux_dirn,gf_and_gz_struct *in_prims,CCTK_REAL *ftilde_gf) {
  #include "./set_Cparameters.h"
