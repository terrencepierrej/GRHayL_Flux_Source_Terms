 ...
 */
void calculate_HLLE_fluxes1(const reconstructed_prims_struct *restrict reconstructed_prims_r, const reconstructed_prims_struct *restrict reconstructed_prims_l,const metric_face_quantities_struct *restrict metric_face_quantities, conservative_fluxes_struct *restrict conservative_fluxes) {

{
calculate_characteristic_speed_1th_direction(reconstructed_prims_r, reconstructed_prims_l, metric_face_quantities, conservative_fluxes);
...
const double gamma_faceDD22 = metric_face_quantities->gamma_faceDD22;
  ...
  const double tmp_5 = B_lU1 + tmp_4*u4_lU2;
  ...
  const double tmp_39 = -tmp_11 + tmp_33*((u4_lU2)*(u4_lU2)) + tmp_37*tmp_38;
  const double tmp_40 = tmp_38*tmp_8;
  const double tmp_41 = tmp_33*u4_lU0;
  const double tmp_42 = beta_faceU1*tmp_40 - tmp_26*tmp_5 + tmp_41*u4_lU2;
  ...
  const double tmp_53 = B_rU1 + tmp_52*u4_rU2;
  ...
  const double tmp_78 = tmp_37*tmp_77 - tmp_56 + tmp_76*((u4_rU2)*(u4_rU2));
  const double tmp_79 = tmp_77*tmp_8;
  const double tmp_80 = tmp_76*u4_rU0;
  const double tmp_81 = beta_faceU1*tmp_79 - tmp_53*tmp_69 + tmp_80*u4_rU2;
  ...
  conservative_fluxes->HLLE_flux_StildeD1 = tmp_0*(tmp_51*(gamma_faceDD01*tmp_46 + gamma_faceDD11*tmp_39 + gamma_faceDD12*tmp_48 + tmp_2*tmp_42) + tmp_85*(gamma_faceDD01*tmp_83 + gamma_faceDD11*tmp_78 + gamma_faceDD12*tmp_84 + tmp_2*tmp_81) - tmp_92*(alpha_face*tmp_49*(gamma_faceDD01*tmp_90 + gamma_faceDD11*tmp_81 + gamma_faceDD12*tmp_91 + tmp_2*tmp_89) - tmp_50*(gamma_faceDD01*tmp_87 + gamma_faceDD11*tmp_42 + gamma_faceDD12*tmp_88 + tmp_2*tmp_86)));
  conservative_fluxes->HLLE_flux_StildeD2 = tmp_0*(tmp_51*(gamma_faceDD02*tmp_46 + gamma_faceDD12*tmp_39 + gamma_faceDD22*tmp_48 + tmp_3*tmp_42) + tmp_85*(gamma_faceDD02*tmp_83 + gamma_faceDD12*tmp_78 + gamma_faceDD22*tmp_84 + tmp_3*tmp_81) - tmp_92*(alpha_face*tmp_49*(gamma_faceDD02*tmp_90 + gamma_faceDD12*tmp_81 + gamma_faceDD22*tmp_91 + tmp_3*tmp_89) - tmp_50*(gamma_faceDD02*tmp_87 + gamma_faceDD12*tmp_42 + gamma_faceDD22*tmp_88 + tmp_3*tmp_86)));
  conservative_fluxes->HLLE_flux_rho_star = tmp_0*(rhob_l*tmp_51*u4_lU2 + rhob_r*tmp_85*u4_rU2 - tmp_92*(-tmp_94 + tmp_96));
  conservative_fluxes->HLLE_flux_tau_tilde = tmp_0*(cmax_dirn1*(-rhob_l*tmp_50*u4_lU2 + tmp_42*tmp_97) + cmin_dirn1*(-rhob_r*tmp_50*u4_rU2 + tmp_81*tmp_97) - tmp_92*(tmp_49*tmp_7*tmp_89 - tmp_86*tmp_97 + tmp_94 - tmp_96));
}
}
