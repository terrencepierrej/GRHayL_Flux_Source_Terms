...
const REAL            NOSIMDsqrt4pi = params->sqrt4pi;  // GRMHD_equations_new_version::sqrt4pi
const REAL_SIMD_ARRAY sqrt4pi = ConstSIMD(NOSIMDsqrt4pi);  // GRMHD_equations_new_version::sqrt4pi
