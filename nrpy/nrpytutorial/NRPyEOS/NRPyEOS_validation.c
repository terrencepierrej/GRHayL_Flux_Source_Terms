...
void NRPyEOS_validation(const NRPyEOS_params_tabulated *restrict eos_params, const int N, const double Ye, const char *restrict filename) {
...
int main(int argc, char **argv) {
  ...
  NRPyEOS_params_tabulated eos_params;
